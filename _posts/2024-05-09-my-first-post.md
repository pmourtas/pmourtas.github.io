...
Figure 1: Exercise 94, Unit 7. (Sarkar, T. & Roychowdhury, S., 2019)
...
Figure 6: The first normal form of the table in figure 5.                                                                            Each attribute contains only atomic values and there are no repeating groups or arrays

 
Figure 7: The second normal form of the table in figure 5.                                                                           All attributes are fully dependent on the primary key

 
Figure 8: The third normal form of the table in figure 5.                                                                           Each attribute is dependent on the Primary key.                                                                                          We also have foreign keys that show the relationships between the tables
